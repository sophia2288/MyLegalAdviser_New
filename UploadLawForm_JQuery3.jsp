...
<script>
  $( function() {
    var availableTags = [
    	...
    	{ label: "排水纠纷", value: "003003009001" },
    	{ label: "相邻通行纠纷", value: "003003009002" },
    	{ label: "建筑物利用关系纠纷", value: "003003009003" },
    	{ label: "相邻通风纠纷", value: "003003009004" },
    	{ label: "日照纠纷", value: "003003009005" },
    	...
    	{ label: "航空器抵押权纠纷", value: "003005001006" },
    	...
    	{ label: "试用买卖合同纠纷", value: "004001009003" },
    	...
    	{ label: "合作开发房地产合同纠纷", value: "004001016002" },
    	...
    	{ label: "车辆建造合同纠纷", value: "004001034007" },
    	...
    	{ label: "人民调解代理合同纠纷", value: "004001039004" },
    	...
    	{ label: "养殖回收合同纠纷", value: "004001047" },
    	{ label: "奖券纠纷", value: "004001048" },
...
<form action="saveLaw" enctype="multipart/form-data" method="post">
    <fieldset>
        ...
        <p>
            ...
            <input type="text" name="fullName" style="width:140px;height:25px"/>
        </p>
        <p>
            <label for="organ">发布机关<span class="star">*</span>： </label>
            <input type="text" name="organ" style="width:140px;height:25px"/>
        </p>
        <p>
            <label for="referenceNo">发文字号：</label>
            <input type="text" name="referenceNo" style="width:140px;height:25px"/>
        </p>
        <p>
            <label for="publishDate">发布日期：</label>
            <input type="text" name="publishDate" style="width:140px;height:25px" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
        </p>
        <p>
            <label for="effectiveDate">施行日期<span class="star">*</span>：</label>
            <input type="text" name="effectiveDate" style="width:140px;height:25px" onClick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"/>
        </p>
        <p>
        ...
        <p>
            ...
            <select name="hierarchy" style="height:28px">
        ...
        <p>
            ...
            <textarea name="aliases" rows="5" style="width:160px"></textarea>
        </p>
