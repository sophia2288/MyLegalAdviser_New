...
public class MSOfficeGeneratorUtils {
	 ...
	 * format. 1 | wdFormatTemplate Microsoft Word template format. 2 | wdFormatText
	 * Microsoft Windows text format. 3 | wdFormatTextLineBreaks Microsoft Windows
	 * text format with line breaks preserved. 4 | wdFormatDOSText Microsoft DOS
	 * text format. 5 | wdFormatDOSTextLineBreaks Microsoft DOS text with line
	 * breaks preserved. 6 | wdFormatRTF Rich text format (RTF). 7 |
	 * wdFormatEncodedText Encoded text format. 7 | wdFormatUnicodeText Unicode text
	 * format. 8 | wdFormatHTML Standard HTML format. 9 | wdFormatWebArchive Web
	 * archive format. 10 | wdFormatFilteredHTML Filtered HTML format. 11 |
	...
	public void html2Word(String html, String wordFile) {
		...
		/*
		 * selectAllContent(); insertText(null);
		 */
		Dispatch.invoke(this.selection, "InsertFile", Dispatch.Method,
