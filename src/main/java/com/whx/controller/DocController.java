...
public class DocController {
	...
	public String saveDoc(@ModelAttribute Doc doc/* , @RequestParam("file") MultipartFile uploadFile, Model model */)
		...
		// String regexStrOfCourt =
		// "(北京市|上海市|天津市|重庆市|河北省|黑龙江省|吉林省|辽宁省|内蒙古自治区|山西省|江苏省|浙江省|安徽省|福建省|江西省|山东省|河南省|湖北省|湖南省|广东省|广西壮族自治区|海南省|四川省|贵州省|云南省|西藏自治区|陕西省|甘肃省|青海省|宁夏回族自治区|新疆维吾尔自治区|新疆建设兵团)?([\\u4e00-\\u9fa5]{1,20}(县|市|旗|区))人民法院";
