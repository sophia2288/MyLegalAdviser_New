    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
				<div class="row">
					<div class="col-md-12">
						<h4  class="text-center lead">用户数据录入</h4>
					</div>
				</div>
				<div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                        <form:form commandName="user" action="saveUser" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<form:input class="form-control" id="account" path="account" placeholder="用户名"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-sm-2 control-label">密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                                <div class="col-sm-10">
                                	<form:password class="form-control" id="password" path="password" placeholder="密码"/>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <footer>
            ...
            <div class="Copyright text-center">
                Copyright &copy; 2009-2018 shanbay.com, all rights reserved.--wuhongxing
            </div>
        </footer>
    </div>
