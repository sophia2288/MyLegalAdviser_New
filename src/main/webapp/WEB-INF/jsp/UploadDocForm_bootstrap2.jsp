...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-center lead">裁判文书录入</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3">
				...
				<form:form commandName="doc" action="saveDoc" method="post"
					...
					<div class="form-group">
						<div class="col-sm-offset-2  col-sm-9">
							<div class="checkbox">
								<label> <form:checkbox id="isImportant"
										path="isImportant" />重要裁判文书
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<form:input class="form-control" id="court"
								path="court.courtCode" />
						</div>
					</div>
					<div class="form-group">
