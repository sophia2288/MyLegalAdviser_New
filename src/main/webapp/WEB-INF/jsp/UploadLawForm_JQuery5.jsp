...
<form action="saveLaw" enctype="multipart/form-data" method="post">
    <fieldset>
        ...
        <p>
            ...
            <textarea id="aliases" name="aliases" rows="5" style="width:165px"></textarea>
        </p>
        <p>
            <label for=fullPathName>文件路径：</label>
            <input type="text" id="fullPathName" name="fullPathName" style="width:180px;height:25px"/>
        </p>
