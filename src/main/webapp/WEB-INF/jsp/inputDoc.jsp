...
<body>
	<div class="container">
		<form:form commandName="doc" action="saveDoc" method="post"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" id="caseclass"
						path="caseclass.classId" />
				</div>
				<div class="col-sm-3"></div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-9">
					<div class="checkbox">
						<label> <form:checkbox id="isImportant" path="isImportant" />重要裁判文书
						</label>
					</div>
				</div>
			</div>
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<label class="radio-inline"> <form:radiobutton
							path="docCategory" value="判决" checked="checked" />判决
					</label> <label class="radio-inline"> <form:radiobutton
							path="docCategory" value="裁定" />裁定
					</label>
				</div>
				<div class="col-sm-3"></div>
			</div>
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<label class="radio-inline"> <form:radiobutton
							path="proceeding" value="一审" checked="checked" />一审
					</label> <label class="radio-inline"> <form:radiobutton
							path="proceeding" value="二审" />二审
					</label> <label class="radio-inline"> <form:radiobutton
							path="proceeding" value="再审" />再审
					</label> <label class="radio-inline"> <form:radiobutton
							path="proceeding" value="特别程序" />特别程序
					</label> <label class="radio-inline"> <form:radiobutton
							path="proceeding" value="执行" />执行
					</label>
				</div>
				<div class="col-sm-3"></div>
			</div>
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<form:input class="form-control" id="court" path="court.courtCode"
						required="required" />
				</div>
				<div class="col-sm-3"></div>
			</div>
			...
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<form:input class="form-control" id="fullPathName"
						path="fullPathName" readonly="true" />
				</div>
				<div class="col-sm-3"></div>
			</div>
	...
	<script type="text/javascript"
		src="bootstrap-3.3.7/js/bootstrap-typeahead.js"></script>
