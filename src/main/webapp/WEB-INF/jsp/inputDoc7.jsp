					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="form-check">
								<form:checkbox class="form-check-input" id="isImportant"
									path="isImportant" />
						...
						<div class="row">
							...
							<div class="col-sm-9">
								<div class="form-check form-check-inline">
									...
									path="docCategory" id="docCategory1"  value="判决书" checked="checked" />
									<label class="form-check-label" for="docCategory1"> 判决 </label>
								</div>
								<div class="form-check form-check-inline">
									<form:radiobutton class="form-check-input" path="docCategory" id="docCategory2" value="裁定书" />
					...
					<div class="form-group required">
						<div class="row">
							...
							<div class="col-sm-9">
								<div class="form-check form-check-inline">
									<form:radiobutton class="form-check-input" 
									path="proceeding" id="proceeding1"  value="一审" checked="checked" />
					...
					<div class="form-group row required">
						...
						<div class="col-sm-6">
							<div class="input-group mb-3">
								<form:input class="form-control" id="judgeDate" path="judgeDate"
									required="required" />
