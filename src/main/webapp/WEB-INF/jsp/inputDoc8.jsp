...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 docInput">
                <form:form commandName="doc" action="saveDoc" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <form:checkbox class="form-check-input" id="isImportant" path="isImportant" />
                                <label class="form-check-label" for="isImportant">重要裁判文书 
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="docCategory" id="docCategory1"
                                        value="判决书" checked="checked" />
                                    <label class="form-check-label" for="docCategory1"> 判决 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="docCategory" id="docCategory2"
                                        value="裁定书" />
                                    <label class="form-check-label" for="docCategory2"> 裁定 </label>
                                </div>
                            </div>
                            <div class="col-sm-1"></div>
                        </div>
                    ...
                    <div class="form-group required">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="proceeding" id="proceeding1" value="一审" checked="checked" />
                                    <label class="form-check-label" for="proceeding1"> 一审 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="proceeding" id="proceeding2" value="二审" />
                                    <label class="form-check-label" for="proceeding2"> 二审 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="proceeding" id="proceeding5" value="特别程序" />
                                    <label class="form-check-label" for="proceeding5"> 特别程序 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="proceeding" id="proceeding3" value="再审" />
                                    <label class="form-check-label" for="proceeding3"> 再审 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <form:radiobutton class="form-check-input" path="proceeding" id="proceeding4" value="执行" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <form:input class="form-control" id="judge" path="judge" placeholder="多个审判员之间用逗号隔开"
    ...
    <script type="text/javascript" src="bootstrap-4.2.1-dist/js/bootstrap3-typeahead.js"></script>
